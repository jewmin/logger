...
TEST(PriorityTest, get_value) {
	...
	EXPECT_EQ(Logger::Priority::GetPriorityValue("WARN"), Logger::Priority::kWarn);
	EXPECT_EQ(Logger::Priority::GetPriorityValue("WARN"), Logger::Priority::kWarning);
...
TEST(PriorityTest, get_name) {
	...
	EXPECT_STREQ(Logger::Priority::GetPriorityName(Logger::Priority::kWarn).c_str(), "WARN");
	EXPECT_STREQ(Logger::Priority::GetPriorityName(Logger::Priority::kWarning).c_str(), "WARN");
