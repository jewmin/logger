...
TEST_F(LayoutTest, basic) {
	...
	EXPECT_STREQ(*basic.Format(record), "1592018476 INFO LayoutTest: test basic layout\n");
}
...
TEST_F(LayoutTest, simple) {
	...
	EXPECT_STREQ(*simple.Format(record), "INFO    : test simple layout\n");
}
...
TEST_F(LayoutTest, empty_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "");
...
TEST_F(LayoutTest, category_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "this is 100%% message: [%c] %m%n");
	EXPECT_STREQ(*pattern.Format(record), "this is 100% message: [LayoutTest] test pattern layout\n");
}
...
TEST_F(LayoutTest, priority_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "this is 100%% message: [%P(%p)] [%c] %m%n");
	EXPECT_STREQ(*pattern.Format(record), "this is 100% message: [INFO(2)] [LayoutTest] test pattern layout\n");
}
...
TEST_F(LayoutTest, timestamp_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "this is 100%% message: %t,%M [%P(%p)] [%c] %m%n");
	EXPECT_STREQ(*pattern.Format(record), "this is 100% message: 1592018476,12 [INFO(2)] [LayoutTest] test pattern layout\n");
}
...
TEST_F(LayoutTest, starttime_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "this is 100%% message: %ums [%P(%p)] [%c] %m%n");
	std::printf("%s", *pattern.Format(record));
}
...
TEST_F(LayoutTest, date_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "this is 100%% message: %d [%P(%p)] [%c] %m%n");
	EXPECT_STREQ(*pattern.Format(record), "this is 100% message: Sat Jun 13 11:21:16 2020 [INFO(2)] [LayoutTest] test pattern layout\n");
}
...
TEST_F(LayoutTest, datetime_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "this is 100%% message: %d{%Y-%m-%d %H:%M:%S,%l} [%P(%p)] [%c] %m%n");
	EXPECT_STREQ(*pattern.Format(record), "this is 100% message: 2020-06-13 11:21:16,012 [INFO(2)] [LayoutTest] test pattern layout\n");
}
...
TEST_F(LayoutTest, format_pattern) {
	...
	EXPECT_STREQ(pattern.GetConversionPattern(), "this is 100%% message: %-20.30d{%Y-%m-%d %H:%M:%S,%l} [%5P(%-3p)] [%c] %10.15m%n");
	EXPECT_STREQ(*pattern.Format(record), "this is 100% message: 2020-06-13 11:21:16,012 [ INFO(2  )] [LayoutTest] test pattern la\n");
}
